		...
		{x86_int,[{start,
			   {x86_int_block,
			    [{x86_int_movq,{deref,{reg,rbp}, -8}, {imm,4}},
			     {x86_int_movq,{deref,{reg,rbp},-16},{deref,{reg,rbp},-8}},
			     {x86_int_addq,{deref,{reg,rbp},-16},{imm,1}},
			     {x86_int_movq,{deref,{reg,rbp},-24},{deref,{reg,rbp},-16}},
			     {x86_int_addq,{deref,{reg,rbp},-24},{imm,2}},
			     {callq,read_int,0},
			     {x86_int_movq,{deref,{reg,rbp},-32},{reg,rax}},
			     {x86_int_negq,{deref,{reg,rbp},-32}},
			     {x86_int_movq,{deref,{reg,rbp},-40},{deref,{reg,rbp},-32}},
